...
// CHECK: @"OBJC_EHTYPE_$_A" = global %struct._objc_typeinfo { ptr ptrauth (ptr getelementptr inbounds (ptr, ptr @objc_ehtype_vtable, i32 2), [i64 2, i64 0, i64 0]), ptr @OBJC_CLASS_NAME_, ptr @"OBJC_CLASS_$_A" }
