...
// CHECK: @_ZTV10TestStruct = unnamed_addr constant { [4 x ptr] } { [4 x ptr] [ptr null, ptr @_ZTI10TestStruct, ptr ptrauth (ptr @_ZN10TestStructD1Ev, [i64 0, i64 52216, i64 ptrtoint (ptr getelementptr inbounds ({ [4 x ptr] }, ptr @_ZTV10TestStruct, i32 0, i32 0, i32 2) to i64)]), ptr ptrauth (ptr @_ZN10TestStructD0Ev, [i64 0, i64 39671, i64 ptrtoint (ptr getelementptr inbounds ({ [4 x ptr] }, ptr @_ZTV10TestStruct, i32 0, i32 0, i32 3) to i64)])] }, align 8

// NODISC: @_ZTI10TestStruct = constant { ptr, ptr } { ptr ptrauth (ptr getelementptr inbounds (ptr, ptr @_ZTVN10__cxxabiv117__class_type_infoE, i64 2), [i64 2, i64 0, i64 0]), ptr @_ZTS10TestStruct }, align 8

// DISC: @_ZTI10TestStruct = constant { ptr, ptr } { ptr ptrauth (ptr getelementptr inbounds (ptr, ptr @_ZTVN10__cxxabiv117__class_type_infoE, i64 2), [i64 2, i64 [[STDTYPEINFO_DISC]], i64 ptrtoint (ptr @_ZTI10TestStruct to i64)]), ptr @_ZTS10TestStruct }, align 8
...
// NODISC: [[AUTHED:%.*]] = call ptr @llvm.ptrauth.auth.p0(ptr [[VPTR]]) [ "ptrauth"(i64 2, i64 0, i64 0) ]
...
// DISC: [[AUTHED:%.*]] = call ptr @llvm.ptrauth.auth.p0(ptr [[VPTR]]) [ "ptrauth"(i64 2, i64 [[STDTYPEINFO_DISC]], i64 [[ADDR]]) ]
