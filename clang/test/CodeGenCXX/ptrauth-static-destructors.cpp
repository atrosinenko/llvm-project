...
// CXAATEXIT:   call i32 @__cxa_atexit(ptr ptrauth (ptr @_ZN3FooD1Ev, [i64 0, i64 0, i64 0]), ptr @global, ptr @__dso_handle)

// CXAATEXIT_DISC: define internal void @__cxx_global_var_init()
// CXAATEXIT_DISC:   call i32 @__cxa_atexit(ptr ptrauth (ptr @_ZN3FooD1Ev, [i64 0, i64 10942, i64 0]), ptr @global, ptr @__dso_handle)

// ATEXIT: define internal void @__cxx_global_var_init()
// ATEXIT:   %{{.*}} = call i32 @atexit(ptr ptrauth (ptr @__dtor_global, [i64 0, i64 0, i64 0]))
...
// ATEXIT_DISC:   %{{.*}} = call i32 @atexit(ptr ptrauth (ptr @__dtor_global, [i64 0, i64 10942, i64 0]))
