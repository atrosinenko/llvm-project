...
// CHECK: call i64 @llvm.ptrauth.sign{{.*}} [ "ptrauth"(i64 2, i64 [[BASE1_VTABLE_DISC]], i64 {{%.*}}) ]
// CHECK: call i64 @llvm.ptrauth.sign{{.*}} [ "ptrauth"(i64 2, i64 [[BASE1_VTABLE_DISC]], i64 {{%.*}}) ]

// DARWIN-LABEL: define {{.*}} ptr @_ZN12VirtualBase2C1Ev
// ELF-LABEL:    define {{.*}} void @_ZN12VirtualBase2C1Ev
// CHECK: call i64 @llvm.ptrauth.sign{{.*}} [ "ptrauth"(i64 2, i64 [[BASE2_VTABLE_DISC]], i64 {{%.*}}) ]
// CHECK: call i64 @llvm.ptrauth.sign{{.*}} [ "ptrauth"(i64 2, i64 [[BASE1_VTABLE_DISC]], i64 {{%.*}}) ]
...
// CHECK: "; b1->a()",
// CHECK: call i64 @llvm.ptrauth.auth{{.*}} [ "ptrauth"(i64 2, i64 [[BASE1_VTABLE_DISC]], i64 {{%.*}}) ]
// CHECK: call void %{{.*}} [ "ptrauth"(i64 0, i64 [[BASE1_A_DISC]], i64 {{%.*}}) ]
// CHECK: "; b2->b()"
// CHECK: call i64 @llvm.ptrauth.auth{{.*}} [ "ptrauth"(i64 2, i64 [[BASE2_VTABLE_DISC]], i64 {{%.*}}) ]
