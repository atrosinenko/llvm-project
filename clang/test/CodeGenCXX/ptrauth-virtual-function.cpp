...
// CHECK: %[[T1:[0-9]+]] = call ptr @llvm.ptrauth.auth.p0(ptr %[[T0]]) [ "ptrauth"(i64 2, i64 0, i64 0) ]
// CHECK: %[[SIGNED_VTADDR:[0-9]+]] = call ptr @llvm.ptrauth.sign.p0(ptr %[[T1]]) [ "ptrauth"(i64 2, i64 0, i64 0) ]
...
// CHECK: %[[V3:.*]] = call ptr @llvm.ptrauth.auth.p0(ptr %[[VTABLE]]) [ "ptrauth"(i64 2, i64 0, i64 0) ]
...
// CHECK: %[[V6:.*]] = call ptr @llvm.ptrauth.auth.p0(ptr %[[VTABLE1]]) [ "ptrauth"(i64 2, i64 0, i64 0) ]
...
// CHECK: %[[T4:[0-9]+]] = call ptr @llvm.ptrauth.auth.p0(ptr %[[VTABLE0]]) [ "ptrauth"(i64 2, i64 0, i64 0) ]
...
// CHECK: %[[T11:[0-9]+]] = call ptr @llvm.ptrauth.auth.p0(ptr %[[VTABLE1]]) [ "ptrauth"(i64 2, i64 0, i64 0) ]
...
// CHECK: load ptr, ptr
// CHECK: %[[VTABLE:.*]] = load ptr, ptr %
// CHECK: %[[T4:.*]] = call ptr @llvm.ptrauth.auth.p0(ptr %[[VTABLE]]) [ "ptrauth"(i64 2, i64 0, i64 0) ]
...
// CHECK: %[[SIGNED_VTADDR:[0-9]+]] = call ptr @llvm.ptrauth.sign.p0(ptr getelementptr inbounds inrange(-16, 40) ({ [7 x ptr] }, ptr @_ZTV2B0, i32 0, i32 0, i32 2)) [ "ptrauth"(i64 2, i64 0, i64 0) ]
...
// CHECK: %[[SIGNED_VTADDR:[0-9]+]] = call ptr @llvm.ptrauth.sign.p0(ptr getelementptr inbounds inrange(-16, 56) ({ [9 x ptr] }, ptr @_ZTV2D0, i32 0, i32 0, i32 2)) [ "ptrauth"(i64 2, i64 0, i64 0) ]
// CHECK: store ptr %[[SIGNED_VTADDR]], ptr %[[THIS]]

// DARWIN-LABEL: define linkonce_odr noundef ptr @_ZN2D1C2Ev(
// ELF-LABEL:    define linkonce_odr void @_ZN2D1C2Ev(
// CHECK: %[[SIGNED_VTADDR:[0-9]+]] = call ptr @llvm.ptrauth.sign.p0(ptr getelementptr inbounds inrange(-16, 48) ({ [8 x ptr] }, ptr @_ZTV2D1, i32 0, i32 0, i32 2)) [ "ptrauth"(i64 2, i64 0, i64 0) ]
// CHECK: store ptr %[[SIGNED_VTADDR]], ptr %[[THIS]]
...
// CHECK: %[[SIGN_VTADDR0:[0-9]+]] = call ptr @llvm.ptrauth.sign.p0(ptr getelementptr inbounds inrange(-16, 56) ({ [9 x ptr], [8 x ptr] }, ptr @_ZTV2D2, i32 0, i32 0, i32 2)) [ "ptrauth"(i64 2, i64 0, i64 0) ]
// CHECK: store ptr %[[SIGN_VTADDR0]], ptr %[[SLOT0]]
// CHECK: %[[T3:[a-z0-9.]+]] = getelementptr inbounds i8, ptr %[[SLOT0]], i64 16
// CHECK: %[[SIGN_VTADDR1:[0-9]+]] = call ptr @llvm.ptrauth.sign.p0(ptr getelementptr inbounds inrange(-16, 48) ({ [9 x ptr], [8 x ptr] }, ptr @_ZTV2D2, i32 0, i32 1, i32 2)) [ "ptrauth"(i64 2, i64 0, i64 0) ]
// CHECK: store ptr %[[SIGN_VTADDR1]], ptr %[[T3]]
...
// CHECK: %[[VTADDR0:[0-9]+]] = call ptr @llvm.ptrauth.auth.p0(ptr %[[T0]]) [ "ptrauth"(i64 2, i64 0, i64 0) ]
// CHECK: %[[SIGN_VTADDR0:[0-9]+]] = call ptr @llvm.ptrauth.sign.p0(ptr %[[VTADDR0]]) [ "ptrauth"(i64 2, i64 0, i64 0) ]
// CHECK: store ptr %[[SIGN_VTADDR0]], ptr %[[SLOT0]]
// CHECK: %[[T9:[0-9]+]] = getelementptr inbounds ptr, ptr %[[VTT]], i64 1
// CHECK: %[[T10:[0-9]+]] = load ptr, ptr %[[T9]]
// CHECK: %[[VTADDR1:[0-9]+]] = call ptr @llvm.ptrauth.auth.p0(ptr %[[T10]]) [ "ptrauth"(i64 2, i64 0, i64 0) ]
// CHECK: %[[VTABLE:[a-z]+]] = load ptr, ptr %[[THIS1]]
// CHECK: %[[T17:[0-9]+]] = call ptr @llvm.ptrauth.auth.p0(ptr %[[VTABLE]]) [ "ptrauth"(i64 2, i64 0, i64 0) ]
...
// CHECK: %[[SIGN_VTADDR1:[0-9]+]] = call ptr @llvm.ptrauth.sign.p0(ptr %[[VTADDR1]]) [ "ptrauth"(i64 2, i64 0, i64 0) ]
