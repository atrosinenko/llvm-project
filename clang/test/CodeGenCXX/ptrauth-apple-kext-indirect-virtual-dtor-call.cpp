...
// CHECK-NEXT: call noundef ptr [[T1]](ptr noundef nonnull align 8 dead_on_return(8) dereferenceable(8) [[T2:%.*]]) [ "ptrauth"(i32 0, i64 ptrtoint (ptr getelementptr inbounds nuw (i8, ptr @_ZTV2B1, i64 16) to i64), i64 14635) ]
// CHECK-LABEL: define void @_Z6DELETEP2B1
// CHECK: [[T3:%.*]] = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_ZTV2B1, i64 16)
// CHECK-NEXT:  call noundef ptr [[T3]](ptr noundef nonnull align 8 dead_on_return(8) dereferenceable(8) [[T4:%.*]]) [ "ptrauth"(i32 0, i64 ptrtoint (ptr getelementptr inbounds nuw (i8, ptr @_ZTV2B1, i64 16) to i64), i64 14635)
