...
void test_auth() {
  ...
  // CHECK-NEXT: [[RESULT:%.*]] = call ptr @llvm.ptrauth.auth.p0(ptr [[PTR]]) [ "ptrauth"(i64 0, i64 0, i64 [[DISC]]) ]
...
void test_strip() {
  // CHECK:      [[PTR:%.*]] = load ptr, ptr @fnptr,
  // CHECK-NEXT: [[RESULT:%.*]] = call ptr @llvm.ptrauth.strip.p0(ptr [[PTR]]) [ "ptrauth"(i64 0) ]
  // CHECK-NEXT: store ptr [[RESULT]], ptr @fnptr,
...
void test_sign_unauthenticated() {
  ...
  // CHECK-NEXT: [[DISC0:%.*]] = load ptr, ptr @ptr_discriminator,
  // CHECK-NEXT: [[DISC:%.*]] = ptrtoint ptr [[DISC0]] to i64
  // CHECK-NEXT: [[RESULT:%.*]] = call ptr @llvm.ptrauth.sign.p0(ptr [[PTR]]) [ "ptrauth"(i64 0, i64 0, i64 [[DISC]]) ]
  // CHECK-NEXT: store ptr [[RESULT]], ptr @fnptr,
...
void test_auth_and_resign() {
  ...
  // CHECK-NEXT: [[DISC0:%.*]] = load ptr, ptr @ptr_discriminator,
  // CHECK-NEXT: [[DISC:%.*]] = ptrtoint ptr [[DISC0]] to i64
  // CHECK-NEXT: [[RESULT:%.*]] = call ptr @llvm.ptrauth.resign.p0(ptr [[PTR]]) [ "ptrauth"(i64 0, i64 0, i64 [[DISC]]), "ptrauth"(i64 3, i64 15, i64 0) ]
  // CHECK-NEXT: store ptr [[RESULT]], ptr @fnptr,
...
void test_auth_load_relative_and_sign() {
  ...
  // CHECK-NEXT: [[DISC0:%.*]] = load ptr, ptr @ptr_discriminator,
  // CHECK-NEXT: [[DISC:%.*]] = ptrtoint ptr [[DISC0]] to i64
  // CHECK-NEXT: [[RESULT:%.*]] = call ptr @llvm.ptrauth.resign.load.relative.p0(ptr [[PTR]], i64 16) [ "ptrauth"(i64 0, i64 0, i64 [[DISC]]), "ptrauth"(i64 3, i64 15, i64 0) ]
  // CHECK-NEXT: store ptr [[RESULT]], ptr @fnptr,
...
void test_auth_blend_generic_discriminator() {
  ...
  // CHECK-NEXT: [[RESULT:%.*]] = call ptr @llvm.ptrauth.auth.p0(ptr [[FNPTR]]) [ "ptrauth"(i64 0, i64 0, i64 [[BLEND]]) ]
  // CHECK-NEXT: store ptr [[RESULT]], ptr @fnptr,
...
void test_sign_blend_generic_discriminator() {
  ...
  // CHECK-NEXT: [[BLEND:%.*]] = call i64 @llvm.ptrauth.blend(i64 [[CAST_PTR]], i64 [[DISC]])
  // CHECK-NEXT: [[FNPTR:%.*]] = load ptr, ptr @fnptr,
  // CHECK-NEXT: [[RESULT:%.*]] = call ptr @llvm.ptrauth.sign.p0(ptr [[FNPTR]]) [ "ptrauth"(i64 0, i64 0, i64 [[BLEND]]) ]
  // CHECK-NEXT: store ptr [[RESULT]], ptr @fnptr,
  unsigned long discr = __builtin_ptrauth_blend_discriminator(ptr_discriminator, int_discriminator);
...
void test_resign_blend_generic_discriminator() {
  ...
  // CHECK-NEXT: [[RESULT:%.*]] = call ptr @llvm.ptrauth.resign.p0(ptr [[FNPTR]]) [ "ptrauth"(i64 0, i64 0, i64 [[BLEND]]), "ptrauth"(i64 1, i64 1234, i64 ptrtoint (ptr @int_discriminator to i64)) ]
  // CHECK-NEXT: store ptr [[RESULT]], ptr @fnptr,
  unsigned long discr = __builtin_ptrauth_blend_discriminator(ptr_discriminator, int_discriminator);
...
void test_auth_blend_discriminator() {
  ...
  // CHECK-NEXT: [[FNPTR:%.*]] = load ptr, ptr @fnptr,
  // CHECK-NEXT: [[RESULT:%.*]] = call ptr @llvm.ptrauth.auth.p0(ptr [[FNPTR]]) [ "ptrauth"(i64 0, i64 42, i64 [[CAST_PTR]]) ]
  // CHECK-NEXT: store ptr [[RESULT]], ptr @fnptr,
...
void test_sign_blend_discriminator() {
  ...
  // CHECK-NEXT: call i64 @llvm.ptrauth.blend(i64 [[CAST_PTR]], i64 42)
  // CHECK-NEXT: [[FNPTR:%.*]] = load ptr, ptr @fnptr,
  // CHECK-NEXT: [[RESULT:%.*]] = call ptr @llvm.ptrauth.sign.p0(ptr [[FNPTR]]) [ "ptrauth"(i64 0, i64 42, i64 [[CAST_PTR]]) ]
  // CHECK-NEXT: store ptr [[RESULT]], ptr @fnptr,
  unsigned long discr = __builtin_ptrauth_blend_discriminator(ptr_discriminator, 42);
  fnptr = __builtin_ptrauth_sign_unauthenticated(fnptr, 0, discr);
}
...
void test_resign_blend_discriminator() {
  ...
  // CHECK-NEXT: [[FNPTR:%.*]] = load ptr, ptr @fnptr,
  // CHECK-NEXT: call i64 @llvm.ptrauth.blend(i64 ptrtoint (ptr @int_discriminator to i64), i64 1234)
  // CHECK-NEXT: [[RESULT:%.*]] = call ptr @llvm.ptrauth.resign.p0(ptr [[FNPTR]]) [ "ptrauth"(i64 0, i64 42, i64 [[CAST_PTR]]), "ptrauth"(i64 1, i64 1234, i64 ptrtoint (ptr @int_discriminator to i64)) ]
  // CHECK-NEXT: store ptr [[RESULT]], ptr @fnptr,
  unsigned long discr = __builtin_ptrauth_blend_discriminator(ptr_discriminator, 42);
  fnptr = __builtin_ptrauth_auth_and_resign(fnptr, 0, discr, 1, __builtin_ptrauth_blend_discriminator(&int_discriminator, 1234));
}
...
void test_resign_twice_the_same_blend() {
  ...
  // CHECK-NEXT: call i64 @llvm.ptrauth.blend(i64 [[CAST_PTR]], i64 42)
  // CHECK-NEXT: [[FNPTR:%.*]] = load ptr, ptr @fnptr,
  // CHECK-NEXT: [[RESULT:%.*]] = call ptr @llvm.ptrauth.resign.p0(ptr [[FNPTR]]) [ "ptrauth"(i64 0, i64 42, i64 [[CAST_PTR]]), "ptrauth"(i64 1, i64 42, i64 [[CAST_PTR]]) ]
  // CHECK-NEXT: store ptr [[RESULT]], ptr @fnptr,
  unsigned long discr = __builtin_ptrauth_blend_discriminator(ptr_discriminator, 42);
