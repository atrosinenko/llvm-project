...
// CHECK: %[[V18:.*]] = call ptr @llvm.ptrauth.resign.p0(ptr %[[V11]]) [ "ptrauth"(i64 1, i64 50, i64 %[[V12]]), "ptrauth"(i64 1, i64 50, i64 %[[V14]]) ]
...
// CHECK: %[[V12:.*]] = ptrtoint ptr %[[V9]] to i64
// CHECK: %[[V14:.*]] = ptrtoint ptr %[[V6]] to i64
// CHECK: %[[V18:.*]] = call ptr @llvm.ptrauth.resign.p0(ptr %[[V11]]) [ "ptrauth"(i64 2, i64 30, i64 %[[V12]]), "ptrauth"(i64 2, i64 30, i64 %[[V14]]) ]
...
// CHECK: %[[V3:.*]] = call ptr @llvm.ptrauth.sign.p0(ptr @g0) [ "ptrauth"(i64 1, i64 50, i64 %[[V0]]) ]
...
// CHECK: %[[V7:.*]] = call ptr @llvm.ptrauth.sign.p0(ptr @g0) [ "ptrauth"(i64 1, i64 50, i64 %[[V4]]) ]
