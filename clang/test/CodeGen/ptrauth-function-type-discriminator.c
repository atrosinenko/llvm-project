...
// CHECK: @test_constant_cast = global ptr ptrauth (ptr @f, [i64 0, i64 2712, i64 0])
void (*test_constant_cast)(int) = (void (*)(int))f;

#ifndef __cplusplus
// CHECKC: @enum_func_ptr = global ptr ptrauth (ptr @enum_func, [i64 0, i64 2712, i64 0])
enum Enum0;
void enum_func(enum Enum0);
void (*enum_func_ptr)(enum Enum0) = enum_func;
#endif

// CHECK: @test_opaque = global ptr ptrauth (ptr @f, [i64 0, i64 0, i64 0])
void *test_opaque =
#ifdef __cplusplus
    (void *)
#endif
...
// CHECK: @test_intptr_t = global i64 ptrtoint (ptr ptrauth (ptr @f, [i64 0, i64 0, i64 0]) to i64)
unsigned long test_intptr_t = (unsigned long)f;

// CHECK: @test_through_long = global ptr ptrauth (ptr @f, [i64 0, i64 2712, i64 0])
void (*test_through_long)(int) = (void (*)(int))(long)f;

// CHECK: @test_to_long = global i64 ptrtoint (ptr ptrauth (ptr @f, [i64 0, i64 0, i64 0]) to i64)
long test_to_long = (long)(double (*)())f;

extern void external_function(void);
// CHECK: @fptr1 = global ptr ptrauth (ptr @external_function, [i64 0, i64 18983, i64 0])
void (*fptr1)(void) = external_function;
// CHECK: @fptr2 = global ptr ptrauth (ptr @external_function, [i64 0, i64 18983, i64 0])
void (*fptr2)(void) = &external_function;

// CHECK: @fptr3 = global ptr ptrauth (ptr @external_function, [i64 2, i64 26, i64 0])
void (*fptr3)(void) = __builtin_ptrauth_sign_constant(&external_function, 2, 26);

// CHECK: @fptr4 = global ptr ptrauth (ptr @external_function, [i64 2, i64 26, i64 ptrtoint (ptr @fptr4 to i64)])
...
// CHECK:  ret ptr ptrauth (ptr @external_function, [i64 0, i64 18983, i64 0])
...
void use_while_incomplete() {
  ...
  // CHECK-NEXT: store ptr ptrauth (ptr @returns_initially_incomplete, [i64 0, i64 25106, i64 0]), ptr [[VAR]]
...
void test_knr() {
  ...
  // CHECKC: [[P:%.*]] = alloca ptr
  // CHECKC: store ptr ptrauth (ptr @knr, [i64 0, i64 18983, i64 0]), ptr [[P]]
...
void test_redeclaration() {
  ...
  // CHECKC: store ptr ptrauth (ptr @redecl, [i64 0, i64 18983, i64 0]), ptr %ptr
  // CHECKC: store ptr ptrauth (ptr @redecl, [i64 0, i64 2712, i64 0]), ptr %ptr2
...
void test_redecl_knr() {
  ...
  // CHECKC: store ptr ptrauth (ptr @knr2, [i64 0, i64 18983, i64 0])
  // CHECKC: call void {{.*}}() [ "ptrauth"(i64 0, i64 18983, i64 0) ]
  ...
  // CHECKC: store ptr ptrauth (ptr @knr2, [i64 0, i64 2712, i64 0])
  // CHECKC: call void {{.*}}(i32 noundef 0) [ "ptrauth"(i64 0, i64 2712, i64 0) ]
}
