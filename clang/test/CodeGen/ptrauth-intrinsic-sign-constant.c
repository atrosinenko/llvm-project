...
// CHECK: @ptr1 = global ptr ptrauth (ptr @external, [i64 0, i64 0, i64 0])
void *ptr1 = __builtin_ptrauth_sign_constant(&external, 0, 0);

// CHECK: @ptr2 = global ptr ptrauth (ptr @external, [i64 0, i64 1234, i64 0])
void *ptr2 = __builtin_ptrauth_sign_constant(&external, 0, 1234);

// CHECK: @ptr3 = global ptr ptrauth (ptr @external, [i64 2, i64 0, i64 ptrtoint (ptr @ptr3 to i64)])
void *ptr3 = __builtin_ptrauth_sign_constant(&external, 2, &ptr3);

// CHECK: @ptr4 = global ptr ptrauth (ptr @external, [i64 2, i64 26, i64 ptrtoint (ptr @ptr4 to i64)])
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    store ptr ptrauth (ptr @external, [i64 0, i64 0, i64 0]), ptr @ptr1, align 8
// CHECK-NEXT:    store ptr ptrauth (ptr @external, [i64 2, i64 1234, i64 0]), ptr @ptr2, align 8
// CHECK-NEXT:    store ptr ptrauth (ptr @external, [i64 2, i64 0, i64 ptrtoint (ptr @ptr3 to i64)]), ptr @ptr3, align 8
// CHECK-NEXT:    store ptr ptrauth (ptr @external, [i64 2, i64 1234, i64 ptrtoint (ptr @ptr4 to i64)]), ptr @ptr4, align 8
// CHECK-NEXT:    ret void
