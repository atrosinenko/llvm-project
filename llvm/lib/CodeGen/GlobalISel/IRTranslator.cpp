...
bool IRTranslator::translateKnownIntrinsic(const CallInst &CI, Intrinsic::ID ID,
  ...
  case Intrinsic::ptrauth_auth: {
    ...
    MachineInstrBuilder MIB = MIRBuilder.buildInstr(
        TargetOpcode::G_PTRAUTH_AUTH, {Dst}, {V, Bundle});
  ...
  case Intrinsic::ptrauth_sign: {
    ...
    MachineInstrBuilder MIB = MIRBuilder.buildInstr(
        TargetOpcode::G_PTRAUTH_SIGN, {Dst}, {V, Bundle});
    SetDeactivationSymbol(MIB);
    return true;
  }
  ...
  case Intrinsic::ptrauth_resign_load_relative: {
    ...
    MachineInstrBuilder MIB = MIRBuilder.buildInstr(
        TargetOpcode::G_PTRAUTH_RESIGN_LOAD_RELATIVE, {Dst},
        {V, OldBundle, NewBundle, Addend});
