...
; O0: {{^}}function(ee-instrument<>),function(aarch64-pointer-auth-early-ir-fixup),always-inline,coro-cond(coro-early,cgscc(coro-split),coro-cleanup,globaldce),alloc-token,function(annotation-remarks),verify,print{{$}}
