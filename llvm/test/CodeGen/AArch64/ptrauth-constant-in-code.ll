...
; ISEL-MIR:       body:
; ISEL-MIR:         %0:gpr64common_and_gpr64noip = COPY $x0
; ISEL-MIR-NEXT:    %1:gpr64common = MOVaddr target-flags(aarch64-page) @const_table_local + 8, target-flags(aarch64-pageoff, aarch64-nc) @const_table_local + 8
; ISEL-MIR-NEXT:    MOVaddrPAC @const_table_local + 8, 2, %0, 1234, implicit-def $x16, implicit-def $x17
; ISEL-MIR-NEXT:    %2:gpr64 = COPY $x16
; ISEL-MIR-NEXT:    STRXui killed %2, %0, 0 :: (store (s64) into %ir.dest)
...
; ISEL-MIR-ELF:       body:
; ISEL-MIR-ELF:         %0:gpr64common_and_gpr64noip = COPY $x0
; ISEL-MIR-ELF-NEXT:    %1:gpr64common = LOADgot target-flags(aarch64-got) @const_table_got
; ISEL-MIR-ELF-NEXT:    %2:gpr64common = ADDXri killed %1, 8, 0
; ISEL-MIR-ELF-NEXT:    LOADgotPAC target-flags(aarch64-got) @const_table_got + 8, 2, %0, 1234, implicit-def $x16, implicit-def $x17, implicit-def $nzcv
; ISEL-MIR-ELF-NEXT:    %3:gpr64 = COPY $x16
; ISEL-MIR-ELF-NEXT:    STRXui killed %3, %0, 0 :: (store (s64) into %ir.dest)
...
; ISEL-MIR-NEXT:    %0:gpr64common_and_gpr64noip = COPY $x0
; ISEL-MIR-NEXT:    %2:gpr64common = ADDXri %1, 8, 0
; ISEL-MIR-NEXT:    %3:gpr64 = PAC %2, 2, 1234, %0, implicit-def dead $x16, implicit-def dead $x17
...
; ISEL-ELF-GOT-MIR:         %0:gpr64common_and_gpr64noip = COPY $x0
; ISEL-ELF-GOT-MIR-NEXT:    %1:gpr64common = LOADgotAUTH target-flags(aarch64-got) @const_table_got, implicit-def dead $x16, implicit-def dead $x17, implicit-def dead $nzcv
; ISEL-ELF-GOT-MIR-NEXT:    %2:gpr64common = ADDXri killed %1, 8, 0
; ISEL-ELF-GOT-MIR-NEXT:    LOADgotPAC target-flags(aarch64-got) @const_table_got + 8, 2, %0, 1234, implicit-def $x16, implicit-def $x17, implicit-def $nzcv
; ISEL-ELF-GOT-MIR-NEXT:    %3:gpr64 = COPY $x16
; ISEL-ELF-GOT-MIR-NEXT:    STRXui killed %3, %0, 0 :: (store (s64) into %ir.dest)
