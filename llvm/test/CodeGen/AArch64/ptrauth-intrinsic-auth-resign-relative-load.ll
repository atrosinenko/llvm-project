...
; TRAP-NEXT:    ret
  %tmp = call i64 @llvm.ptrauth.resign.load.relative(i64 %arg, i64 -256) [ "ptrauth"(i64 0, i64 0, i64 %arg1), "ptrauth"(i64 0, i64 0, i64 %arg2) ]
  ret i64 %tmp
}
...
; TRAP-NEXT:    mov x0, x16
; TRAP-NEXT:    ret
  %tmp = call i64 @llvm.ptrauth.resign.load.relative(i64 %arg, i64 256) [ "ptrauth"(i64 1, i64 0, i64 %arg1), "ptrauth"(i64 0, i64 0, i64 %arg2) ]
  ret i64 %tmp
}
...
; TRAP-NEXT:    mov x0, x16
; TRAP-NEXT:    ret
  %tmp = call i64 @llvm.ptrauth.resign.load.relative(i64 %arg, i64 256) [ "ptrauth"(i64 2, i64 0, i64 %arg1), "ptrauth"(i64 0, i64 0, i64 %arg2) ]
  ret i64 %tmp
}
...
; TRAP-NEXT:    mov x0, x16
; TRAP-NEXT:    ret
  %tmp = call i64 @llvm.ptrauth.resign.load.relative(i64 %arg, i64 256) [ "ptrauth"(i64 3, i64 0, i64 %arg1), "ptrauth"(i64 2, i64 0, i64 %arg2) ]
  ret i64 %tmp
}
...
; TRAP-NEXT:    mov x0, x16
; TRAP-NEXT:    ret
  %tmp = call i64 @llvm.ptrauth.resign.load.relative(i64 %arg, i64 256) [ "ptrauth"(i64 0, i64 0, i64 0), "ptrauth"(i64 3, i64 0, i64 %arg2) ]
  ret i64 %tmp
}
...
; TRAP-NEXT:    mov x0, x16
; TRAP-NEXT:    ret
  %tmp = call i64 @llvm.ptrauth.resign.load.relative(i64 %arg, i64 256) [ "ptrauth"(i64 2, i64 0, i64 %arg1), "ptrauth"(i64 3, i64 0, i64 0) ]
  ret i64 %tmp
}
...
; TRAP-NEXT:    mov x0, x16
; TRAP-NEXT:    ret
  %tmp = call i64 @llvm.ptrauth.resign.load.relative(i64 %arg, i64 256) [ "ptrauth"(i64 2, i64 0, i64 %arg1), "ptrauth"(i64 2, i64 256, i64 0) ]
  ret i64 %tmp
}
...
; TRAP-NEXT:    mov x0, x16
; TRAP-NEXT:    ret
  %tmp = call i64 @llvm.ptrauth.resign.load.relative(i64 %arg, i64 -2556) [ "ptrauth"(i64 2, i64 0, i64 %arg1), "ptrauth"(i64 2, i64 256, i64 0) ]
  ret i64 %tmp
}
...
; TRAP-NEXT:    mov x0, x16
; TRAP-NEXT:    ret
  %tmp = call i64 @llvm.ptrauth.resign.load.relative(i64 %arg, i64 32556) [ "ptrauth"(i64 2, i64 0, i64 %arg1), "ptrauth"(i64 2, i64 256, i64 0) ]
  ret i64 %tmp
}
...
; TRAP-NEXT:    ret
  ...
  %15 = tail call i64 @llvm.ptrauth.resign.load.relative(i64 %1, i64 0) [ "ptrauth"(i64 2, i64 29199, i64 0), "ptrauth"(i64 0, i64 29199, i64 0) ]
  ret void
}
