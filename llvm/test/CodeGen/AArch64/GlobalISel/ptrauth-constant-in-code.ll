...
; ISEL-MIR-NEXT:    %11:gpr64common = MOVaddr target-flags(aarch64-page) @const_table_local + 8, target-flags(aarch64-pageoff, aarch64-nc) @const_table_local + 8
...
; ISEL-MIR-NEXT:    %15:gpr64 = COPY %2
; ISEL-MIR-NEXT:    STRXui %15, %0, 0 :: (store (p0) into %ir.dest)
...
; ISEL-MIR-ELF-NEXT:    %5:gpr64common = LOADgot target-flags(aarch64-got) @const_table_got
; ISEL-MIR-ELF-NEXT:    %4:gpr64common = ADDXri %5, 8, 0
...
; ISEL-MIR-ELF-NEXT:    %2:gpr64 = COPY $x16
; ISEL-MIR-ELF-NEXT:    %11:gpr64 = COPY %2
; ISEL-MIR-ELF-NEXT:    STRXui %11, %0, 0 :: (store (p0) into %ir.dest)
...
; ISEL-MIR-NEXT:    %4:gpr64common = ADDXri %1, 8, 0
; ISEL-MIR-NEXT:    %6:gpr64 = PAC %4, 2, 1234, %2, implicit-def dead $x16, implicit-def dead $x17
; ISEL-MIR-NEXT:    %11:gpr64 = COPY %6
; ISEL-MIR-NEXT:    STRXui %11, %0, 0 :: (store (p0) into %ir.dest)
; ISEL-MIR-NEXT:    RET_ReallyLR
;
...
; ISEL-ELF-GOT-MIR-NEXT:    %5:gpr64common = LOADgotAUTH target-flags(aarch64-got) @const_table_got
; ISEL-ELF-GOT-MIR-NEXT:    %4:gpr64common = ADDXri %5, 8, 0
; ISEL-ELF-GOT-MIR-NEXT:    %1:gpr64noip = COPY %0
; ISEL-ELF-GOT-MIR-NEXT:    LOADgotPAC target-flags(aarch64-got) @const_table_got + 8, 2, %1, 1234, implicit-def $x16, implicit-def $x17, implicit-def $nzcv
; ISEL-ELF-GOT-MIR-NEXT:    %2:gpr64 = COPY $x16
; ISEL-ELF-GOT-MIR-NEXT:    %11:gpr64 = COPY %2
; ISEL-ELF-GOT-MIR-NEXT:    STRXui %11, %0, 0 :: (store (p0) into %ir.dest)
