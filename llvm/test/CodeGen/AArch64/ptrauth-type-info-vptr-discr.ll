...
@_ZTI10Disc   = constant { ptr, ptr } { ptr ptrauth (ptr getelementptr inbounds (ptr, ptr @_ZTVN10__cxxabiv117__class_type_infoE, i64 2), [i64 2, i64 45546, i64 ptrtoint (ptr @_ZTI10Disc to i64)]), ptr @_ZTS10Disc }, align 8
@_ZTS10Disc   = constant [4 x i8] c"Disc", align 1

@_ZTI10NoDisc = constant { ptr, ptr } { ptr ptrauth (ptr getelementptr inbounds (ptr, ptr @_ZTVN10__cxxabiv117__class_type_infoE, i64 2), [i64 2, i64 45546, i64 0]), ptr @_ZTS10NoDisc }, align 8
